 ...
 * @param pageSize
 */
function  queryNewss (searchText,currentPage,pageSize) {
    ...
    if(searchText==null||searchText==''){
        ...
        var bodyParam={'page':currentPage,'size':pageSize,'title':'%'+searchText+'%'};
    }
    ...
    httpR.HttpRequest(function(response){
        ...
        if(status=='0'){
            ...
            for(var o in data){
                ...
                html+='<td><a class="updateNews" href="" index='+o+' data-toggle="modal" ><span class="label label-info label-mini">修改</span></a>   ' +
