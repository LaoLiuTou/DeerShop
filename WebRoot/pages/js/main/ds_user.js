 ...
 * @param pageSize
 */
function  queryUsers (searchText,currentPage,pageSize) {
    ...
    if(searchText==null||searchText==''){
        ...
        var bodyParam={'page':currentPage,'size':pageSize,'search':searchText};
    }
    ...
    httpR.HttpRequest(function(response){
        ...
        if(status=='0'){
            ...
            for(var o in data){
                ...
                if(userinfo!=null){
                    if(JSON.parse(userinfo)['username']!=data[o].username){
                        html+='<a class="deleteUser" href="" index='+o+' data-toggle="modal" data-target="#delete-box"><span class="label label-info label-mini">删除</span></a></td>\n';
                    }
                }
                html+='</tr>';
            }
